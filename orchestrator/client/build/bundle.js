...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_symbol_observable__ = __webpack_require__(12);
...
var preact_redux_esm = __webpack_require__(10);
...
// CONCATENATED MODULE: ./src/components/server-status/server-status-interfaces.ts
var IServerState;
(function (IServerState) {
    IServerState[IServerState["Connected"] = 0] = "Connected";
    IServerState[IServerState["Disconnected"] = 1] = "Disconnected";
})(IServerState || (IServerState = {}));
;

// CONCATENATED MODULE: ./src/reducers/action-creators.ts
...
// CONCATENATED MODULE: ./src/components/server-status/server-status-actions.ts

var setServerStatus = createActionCreator('set.server.status');

// CONCATENATED MODULE: ./src/components/server-status/server-status-reducer.ts
...
var serverStatusReducer = function (state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case setServerStatus.type: {
            return __assign({}, state, { status: setServerStatus.unwrap(action) });
        }
        default: {
            return state;
        }
...
var middleware = Object(es["a" /* applyMiddleware */])(lib_default.a);
var store = Object(es["d" /* createStore */])(Object(es["c" /* combineReducers */])({
...
var app_App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (Object(preact_esm["b" /* h */])(preact_redux_esm["a" /* Provider */], { store: store },
...
Object(preact_esm["c" /* render */])(Object(preact_esm["b" /* h */])(app_App, null), document.querySelector('#js-vsrtc-e2e-tests-app'));
