(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vsrtc-e2e-tests-ochestrator-client"] = factory();
	else
		root["vsrtc-e2e-tests-ochestrator-client"] = factory();
})(this, function() {
...
// removed by extract-text-webpack-plugin
module.exports = {"bulkButtons":"test-scenarios__bulkButtons___3TODM","checkbox":"test-scenarios__checkbox___Td6jz","buttons":"test-scenarios__buttons___3aCxg","bulkButton":"test-scenarios__bulkButton___3pCMV"};
...
var preact_esm = __webpack_require__(10);

// EXTERNAL MODULE: ./node_modules/preact-redux/dist/preact-redux.esm.js
var preact_redux_esm = __webpack_require__(31);
...
// CONCATENATED MODULE: ./src/tests/tests.ts
var scenarios = {};
var cnt = 0;
...
// CONCATENATED MODULE: ./src/reducers/test-scenarios/test-scenarios-actions.ts

var setTestScenarios = createActionCreator('scenarios.set.scenarios');

// CONCATENATED MODULE: ./src/reducers/test-scenarios/test-scenarios-reducer.ts
...
var initialState = {};
var testScenariosReducer = function (state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case setTestScenarios.type: {
            var testScenarios = setTestScenarios.unwrap(action);
            return __assign({}, testScenarios);
        }
        default:
            return state;
    }
...
var store_store = Object(es["d" /* createStore */])(Object(es["c" /* combineReducers */])({
    testScenarios: testScenariosReducer
}), Object(es["a" /* applyMiddleware */])(lib_default.a));
var store_socket = new socket(store_store);
store_store.dispatch(setTestScenarios(scenarios));

// CONCATENATED MODULE: ./src/reducers/test-scenarios/test-scenarios-selectors.ts
var getTestScenarios = function (state) {
    return state.testScenarios;
};

// EXTERNAL MODULE: ./src/components/test-scenarios/test-scenarios.scss
var test_scenarios = __webpack_require__(68);
var test_scenarios_default = /*#__PURE__*/__webpack_require__.n(test_scenarios);

// CONCATENATED MODULE: ./src/components/test-scenarios/test-scenarios.tsx
var test_scenarios___extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
    return function (d, b) {
...
;
var test_scenarios_TestScenariosComponent = /** @class */ (function (_super) {
    test_scenarios___extends(TestScenariosComponent, _super);
    function TestScenariosComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TestScenariosComponent.prototype.renderScenarios = function (testScenarios) {
        if (testScenarios === void 0) { testScenarios = {}; }
        var ids = Object.keys(testScenarios);
        console.log(ids);
        return ids.map(function (id, i) {
            return (Object(preact_esm["b" /* h */])("div", null, id));
        });
    };
    TestScenariosComponent.prototype.render = function () {
        return (Object(preact_esm["b" /* h */])("div", null, this.renderScenarios(this.props.testScenarios)));
    };
    TestScenariosComponent = __decorate([
        style(test_scenarios_default.a)
    ], TestScenariosComponent);
    return TestScenariosComponent;
...
var TestScenarios = Object(preact_redux_esm["b" /* connect */])(mapStateToProps)(test_scenarios_TestScenariosComponent);
...
var app_App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (Object(preact_esm["b" /* h */])(preact_redux_esm["a" /* Provider */], { store: store_store },
            Object(preact_esm["b" /* h */])("div", { className: 'app' },
                Object(preact_esm["b" /* h */])(TestScenarios, null))));
    };
    App = app___decorate([
        style(app_default.a)
    ], App);
